...
var zombieSwarmSerialised = nox.serialise(zombieSwarm);
var zombieSwarmDeSerialised = nox.deserialise(zombieSwarmSerialised);

console.log("--------------------");
console.log(zombieSwarmSerialised);
console.log("--------------------");
_.each(zombieSwarmDeSerialised.zombies,(zombie)=>{
   console.log(nox.deNox(zombie));
});
...
module.exports = {
   ...
   zombieSwarmSerialised: zombieSwarmSerialised,
   zombieSwarmDeSerialised: zombieSwarmDeSerialised,
};
